...
enru_model = AutoModelForSeq2SeqLM.from_pretrained("t5-base")

# Модель для перевода с русского на английский
ruen_tokenizer = AutoTokenizer.from_pretrained("t5-base")
ruen_model = AutoModelForSeq2SeqLM.from_pretrained("t5-base")
